...
export default function TechnicianPortal() {
  ...
  async function save() {
    const payload = { ...form, technicianId: selectedTech, materials: form.materials.map((m) => ({ ...m, serialNumbers: String(m.serialNumbersText || '').split(/\n|,|;/).map((s) => s.trim()).filter(Boolean) })) };
    try {
