  ...
  return (
    <div className="page-grid print-page">
      ...
      <section className="paper">
        <div className="paper-head"><div><h1>GUIA DE ENTREGA DE MATERIAL</h1><p>Prestadora de Serviço Telecom</p></div><strong>{transfer.transferNumber}</strong></div>
        <div className="paper-grid"><p><b>Técnico:</b> {transfer.Technician?.name}</p><p><b>CPF:</b> {transfer.Technician?.document || '-'}</p><p><b>Data:</b> {new Date(transfer.deliveredAt).toLocaleString('pt-BR')}</p><p><b>Status:</b> {transfer.status}</p></div>
        ...
        <div className="signature-area"><div><span></span><p>Assinatura do Técnico</p></div><div><span></span><p>Responsável pelo Estoque</p></div></div>
