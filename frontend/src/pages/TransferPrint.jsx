  ...
  return (
    <div className="page-grid print-page">
      ...
      <section className="paper">
        ...
        <p className="paper-note">{isReturn ? 'Declaro que os materiais listados acima foram devolvidos pelo técnico e conferidos para retorno ao estoque.' : 'Declaro que recebi os materiais listados acima, com os números de série discriminados, ficando responsável pela guarda, utilização em OS ou devolução formal ao estoque.'}</p>
      </section>
