...
Material.hasMany(TechnicianTool, { foreignKey: 'materialId' });
TechnicianTool.belongsTo(Material, { foreignKey: 'materialId' });
Warehouse.hasMany(TechnicianTool, { as: 'stockTools', foreignKey: 'sourceWarehouseId' });
TechnicianTool.belongsTo(Warehouse, { as: 'sourceWarehouse', foreignKey: 'sourceWarehouseId' });
